...
public class TestData implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) throws Exception {
                ...
                postEditor.create(
                                ...
                                Instant.parse("2022-03-03T13:50:00Z"),
                ...
                postEditor.create("Deploying a PlantUML Spring Boot application in a docker container to sloppy.io",
                                ...
                                "Deploying Spring Boot applications", true);

                readingListItemEditor.create("Confessions of a low code convert", Instant.parse("2022-04-01T13:50:00Z"),
                                "https://thenewstack.io/confessions-of-a-low-code-convert/", "Low code for the win",
                                Set.of("low code"), true);
